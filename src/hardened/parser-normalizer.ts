...
const ADMITTED_KINDS = new Set([
    ...
    "LAMBDA", "MINUS", "MOD_LIST", "MULTIPLICATION", "NAME", "NAME_TYPE_INIT", "NAMESPACE", "NEW", "NOT", "OBJECT", "OP", "PACKAGE", "PARAMETER", "PARAMETER_LIST", "PLUS",
    "OR", "POST_DEC", "POST_INC", "PRE_DEC", "PRE_INC", "PROP", "RELATION", "REST", "RETURN", "SET", "SHIFT", "SHORT_VECTOR", "SWITCH", "SWITCH_BLOCK", "THROW", "TRY", "TYPE", "TYPEOF", "USE", "VALUE", "VAR", "VAR_LIST", "VECTOR", "WHILE",
]);
