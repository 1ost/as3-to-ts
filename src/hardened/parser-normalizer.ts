...
const ADMITTED_KINDS = new Set([
    ...
    "CASE", "CASES", "CATCH", "COND", "DEFAULT", "DO", "ENCAPSULATED", "EQUALITY", "EXPR_LIST", "EXTENDS", "FINALLY", "FOR", "FOREACH", "FUNCTION", "GET", "IDENTIFIER", "IF", "IMPORT", "IN", "INIT", "ITER", "LITERAL", "MODIFIER",
