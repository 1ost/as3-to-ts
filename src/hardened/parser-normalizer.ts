...
const ADMITTED_KINDS = new Set([
    ...
    "OR", "POST_DEC", "POST_INC", "PRE_DEC", "PRE_INC", "PROP", "RELATION", "REST", "RETURN", "SET", "SHIFT", "SHORT_VECTOR", "SWITCH", "SWITCH_BLOCK", "THROW", "TRY", "TYPE", "USE", "VALUE", "VAR", "VAR_LIST", "VECTOR", "WHILE",
]);
