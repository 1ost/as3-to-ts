...
const ADMITTED_KINDS = new Set([
    ...
    "CASE", "CASES", "COND", "DEFAULT", "DO", "ENCAPSULATED", "EQUALITY", "EXPR_LIST", "EXTENDS", "FOR", "FOREACH", "FUNCTION", "GET", "IDENTIFIER", "IF", "IMPORT", "IN", "INIT", "ITER", "LITERAL", "MODIFIER",
    "MINUS", "MOD_LIST", "MULTIPLICATION", "NAME", "NAME_TYPE_INIT", "NEW", "NOT", "OP", "PACKAGE", "PARAMETER", "PARAMETER_LIST", "PLUS",
    "OR", "POST_DEC", "POST_INC", "PRE_DEC", "PRE_INC", "RELATION", "RETURN", "SET", "SWITCH", "SWITCH_BLOCK", "THROW", "TYPE", "VAR", "VAR_LIST", "VECTOR", "WHILE",
]);
