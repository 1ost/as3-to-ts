...
const ADMITTED_KINDS = new Set([
    ...
    "CASE", "CASES", "CATCH", "COND", "DEFAULT", "DO", "ENCAPSULATED", "EQUALITY", "EXPR_LIST", "EXTENDS", "FINALLY", "FOR", "FOREACH", "FUNCTION", "GET", "IDENTIFIER", "IF", "IMPLEMENTS", "IMPLEMENTS_LIST", "IMPORT", "IN", "INIT", "INTERFACE", "ITER", "LABEL", "LITERAL", "MODIFIER",
    "MINUS", "MOD_LIST", "MULTIPLICATION", "NAME", "NAME_TYPE_INIT", "NEW", "NOT", "OBJECT", "OP", "PACKAGE", "PARAMETER", "PARAMETER_LIST", "PLUS",
    "OR", "POST_DEC", "POST_INC", "PRE_DEC", "PRE_INC", "PROP", "RELATION", "REST", "RETURN", "SET", "SHIFT", "SWITCH", "SWITCH_BLOCK", "THROW", "TRY", "TYPE", "USE", "VALUE", "VAR", "VAR_LIST", "VECTOR", "WHILE",
]);
