...
const ADMITTED_KINDS = new Set([
    ...
    "CASE", "CASES", "DEFAULT", "DO", "ENCAPSULATED", "EQUALITY", "EXTENDS", "FUNCTION", "GET", "IDENTIFIER", "IF", "IMPORT", "INIT", "LITERAL", "MODIFIER",
    "MINUS", "MOD_LIST", "MULTIPLICATION", "NAME", "NAME_TYPE_INIT", "NEW", "NOT", "OP", "PACKAGE", "PARAMETER", "PARAMETER_LIST", "PLUS",
    "OR", "POST_DEC", "POST_INC", "PRE_DEC", "PRE_INC", "RELATION", "RETURN", "SET", "SWITCH", "SWITCH_BLOCK", "THROW", "TYPE", "VAR_LIST", "VECTOR", "WHILE",
]);
