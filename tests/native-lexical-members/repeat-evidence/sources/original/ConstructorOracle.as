package {
 ...
 public class ConstructorOracle extends Sprite {
  ...
  public function ConstructorOracle(){
   var x:LexicalRoot=new LexicalRoot(),y:LexicalRoot=new LexicalRoot();
   rec("defaults",function():*{return [x.read(),x.invoke(2),LexicalRoot.staticRead(),x.arrayRead(),x.publicValue];});
   ...
   rec("static-closure",function():*{var f:Function=LexicalRoot.callback();return [f("12"),LexicalRoot.staticRead(),f===LexicalRoot.callback(),f.length];});
   ...
   rec("nested-shadow",function():*{return x.nestedShadow()("nested");});
   rec("nested-lexical",function():*{return x.nestedLexical()();});
   ...
   rec("static-arity-missing",function():*{var f:Function=LexicalRoot.callback();return f();});
   rec("coercion-order",function():*{return [x.write({valueOf:function():*{events.push("valueOf");return 14;}}),x.read()];});
   var result:Object={rows:rows,reflection:[describeType(LexicalRoot).toXMLString()],instances:[describeType(x).toXMLString()]};
