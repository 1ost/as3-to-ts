package probe {
 public class LexicalRoot {
  ...
  public static function callback():* { return LexicalRoot.event; }
  ...
  public function nestedShadow():* { return function(secret:*):* {return secret;}; }
  public function nestedLexical():* { var owner:LexicalRoot = this; return function():* {return owner.secret;}; }
