...
for(const body of ['protected static var value:String=String(7);','protected static var value:Number=7;','protected static var value:Boolean=true;','private static var value:String=String(7);']){
