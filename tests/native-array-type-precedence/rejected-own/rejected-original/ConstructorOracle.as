package {
 ...
 public class ConstructorOracle extends Sprite {
  public function ConstructorOracle() {
   ...
   ExternalInterface.call('oracleDone',{rows:rows,reflection:[describeType(probe.Array).toXMLString(),describeType(Holder).toXMLString()],instances:[describeType(a).toXMLString(),describeType(h).toXMLString()]});
  }
 }
}
