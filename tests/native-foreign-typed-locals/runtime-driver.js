...
const errorRows=[];function failure(v){try{x.initialize(v);}catch(e){return e;}return null;}function fields(e){return [field(e,'name'),field(e,'message'),field(e,'errorID')];}
