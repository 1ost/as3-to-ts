...
for(const member of ['public static const value:int=make();public static function make():*{return 7;}', 'public static const value:Function=null;', 'public const value:int=3+4;', 'private static const value:int=7;', 'public static const value:int;', 'public static const value:Number=NaN;'])reject(member);
