...
Run `npm run tsc` and `npm run test:native-generated-constants` with the sibling
...
computed instance constants and private static constants as unsupported. Native Event
...
Public instance primitive literal constants have a separate ten-row AIR fixture
in `tests/native-generated-instance-constants`. This static fixture now keeps its
instance rejection control for a computed initializer.
