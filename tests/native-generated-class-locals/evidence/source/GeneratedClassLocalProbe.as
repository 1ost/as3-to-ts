...
import refs.Entry;import refs.Constructed;import refs.Peer;import elsewhere.Peer;import refs.Companion;import refs.Qualified;import refs.SamePackage;import refs.cycle.Left;import refs.cycle.Right;import refs.State;import refs.DeferredPeer;import refs.DeferredHolder;
public class GeneratedClassLocalProbe extends Sprite {private var output:Object;public function snapshot():Object{return {ready:true,failure:"",observations:[{id:"complete",value:output}]};}public function GeneratedClassLocalProbe(){
...
row("constructor-local-peer",{run:function():*{return new Constructed(peer).stored;}},"run",[]);
row("constructor-local-null",{run:function():*{return new Constructed(null).stored;}},"run",[]);
row("constructor-local-invalid",{run:function():*{return new Constructed(other).stored;}},"run",[]);
var errorRows=[];function failure(v:*):*{try{x.initialize(v);}catch(e:*){return e;}return null;}function fields(e:*):*{return [e.name,typeof e.message,e.message===null,e.errorID];}
...
var classes=[Constructed,Entry,refs.Peer,elsewhere.Peer,Companion,Qualified,SamePackage,Left,Right,State,DeferredPeer,DeferredHolder],objects=[new Constructed(peer),x,peer,other,companion,q,same,left,right,new State(),deferred,holder],reflection=[],instances=[];
...
output={rows:rows,initializationRows:initializationRows,errorRows:errorRows,reflection:reflection,instances:instances};
}}}
