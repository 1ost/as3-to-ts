...
try {
    const source = [
        ...
        "        public function bits():void { var flags:int = 1 | 2; var shifted:uint = flags >>> 1; var inverted:int = ~flags; flags >>>= 1; }",
    ...
    assert.equal(semantic.declaration.members[11].body[3].expression.value.kind, "coercion");
