...
Eleven guards retain unsupported compound/update/delete, const, duplicate local,
...
parameters/fields, generated typed locals, compound writes and source atom identity
