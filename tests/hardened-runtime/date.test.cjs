...
test('authenticated intrinsic Date retains zeroarg and six-component calendar relationships',t=>{
 ...
 for(const args of [[0],[2026,0],[2026,0,1],[2026,0,1,0],[2026,0,1,0,0],[2026,0,1,0,0,0,0]])assert.throws(()=>new AS3Date(...args),TypeError);
