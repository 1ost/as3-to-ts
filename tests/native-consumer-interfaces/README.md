...
Thirteen rejection checks retain field, ancestry, implementation, constructor,
accessor, rest/default, arguments and lexical-scope boundaries. Three
...
Nominal `is`/`as` and direct cast member access are qualified separately by
`native-interface-type-operations`, including unregistered consumers.
